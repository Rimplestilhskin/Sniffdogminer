...
SET commandserver1=%minerpath% -uri stratum://t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr195@eu1-zcash.flypool.org:3333 -logfile miner.log -max-temperature 80
SET commandserver2=%minerpath% -uri stratum://t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr195@eu1-zcash.flypool.org:3333 -logfile miner.log -max-temperature 80
SET commandserver3=%minerpath% -uri stratum://t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr195@eu1-zcash.flypool.org:3333 -logfile miner.log -max-temperature 80
SET commandserver4=%minerpath% -uri stratum://t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr195@eu1-zcash.flypool.org:3333 -logfile miner.log -max-temperature 80
SET commandserver5=%minerpath% -uri stratum://t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr195@eu1-zcash.flypool.org:3333 -logfile miner.log -max-temperature 80
...
SET warningslist=/C:".*Temperature for device .* is .*, slowing down for .* seconds.*"
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -uri stratum://t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr195@eu1-zcash.flypool.org:3333 -logfile miner.log -max-temperature 80
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
